...
On podem veure que tenim 5 punts, una altura de aqueducte de 6, $\alpha$ = 180 i $\beta$ = 20. Si ho representem en un eix de coordenades, el perfil del sòl ens queda de la següent manera:\\
...
\label{demostracio:exemplecoordenades}
\end{center}
\end{figure}

Si ho representem en forma de digraf (ja descartant les opcions que no són vàlides) ens queda el següent:
\begin{figure}[htbp]
\begin{center}
